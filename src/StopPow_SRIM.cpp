...
double StopPow_SRIM::dEdx_MeV_um(double E)
{
    // check limits:
    ...
    std::vector<std::vector<double>>::iterator val2 =
            lower_bound(data.begin(), data.end(), E, find_compare);
...
double StopPow_SRIM::dEdx_MeV_mgcm2(double E)
{
