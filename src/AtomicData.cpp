...
const std::array<double, AtomicData::n> AtomicData::AMU = {
        {1.008,      4.002602,  6.94,        9.012182, 10.81,      12.011,  14.007,      15.999,
         18.9984032, 20.1797,   22.98976928, 24.305,   26.9815386, 28.085,  30.973762,   32.06,
         35.45,      39.948,    39.0983,     40.078,   44.955912,  47.867,  50.9415,     51.9961,
         54.938045,  55.845,    58.933195,   58.6934,  63.546,     65.38,   69.723,      72.63,
         74.9216,    78.96,     79.904,      83.798,   85.4678,    87.62,   88.90585,    91.224,
         92.90638,   95.96,     98,          101.07,   102.9055,   106.42,  107.8682,    112.411,
         114.818,    118.71,    121.76,      127.6,    126.90447,  131.293, 132.9054519, 137.327,
         138.90547,  140.116,   140.90765,   144.242,  145,        150.36,  151.964,     157.25,
         158.92535,  162.5,     164.93032,   167.259,  168.93421,  173.054, 174.9668,    178.49,
         180.94788,  183.84,    186.207,     190.23,   192.217,    195.084, 196.966569,  200.59,
         204.38,     207.2,     208.9804,    209,      210,        222,     223,         226,
         227,        232.03806, 231.03588,   238.02891}};

// standard density data
const std::array<double, AtomicData::n> AtomicData::rho = {
        {0.00008988, 0.0001785, 0.534, 1.85,  2.34,    2.267, 0.0012506, 0.001429, 0.001696,
         0.0008999,  0.971,     1.738, 2.698, 2.3296,  1.82,  2.067,     0.003214, 0.0017837,
         0.862,      1.54,      2.989, 4.54,  6.11,    7.15,  7.44,      7.874,    8.86,
         8.912,      8.96,      7.134, 5.907, 5.323,   5.776, 4.809,     3.122,    0.003733,
         1.532,      2.64,      4.469, 6.506, 8.57,    10.22, 11.5,      12.37,    12.41,
         12.02,      10.501,    8.69,  7.31,  7.287,   6.685, 6.232,     4.93,     0.005887,
         1.873,      3.594,     6.145, 6.77,  6.773,   7.007, 7.26,      7.52,     5.243,
         7.895,      8.229,     8.55,  8.795, 9.066,   9.321, 6.965,     9.84,     13.31,
         16.654,     19.25,     21.02, 22.61, 22.56,   21.46, 19.282,    13.5336,  11.85,
         11.342,     9.807,     9.32,  7,     0.00973, 1.87,  5.5,       10.07,    11.72,
         15.37,      18.95}};
...
const std::array<double, AtomicData::n> AtomicData::ioniz = {
        {18.8, 41.7, 47.6, 62.7, 76,  77.3, 86.7, 97.7, 120, 139, 148, 156, 162, 165, 172, 180,
         185,  194,  193,  196,  218, 230,  239,  259,  270, 280, 296, 310, 322, 320, 324, 330,
         338,  340,  349,  358,  358, 363,  370,  378,  390, 406, 410, 423, 443, 458, 466, 471,
         480,  487,  494,  495,  498, 497,  490,  483,  480, 493, 507, 521, 537, 548, 562, 564,
         585,  600,  623,  640,  652, 662,  672,  682,  684, 693, 698, 707, 735, 759, 755, 756,
         748,  759,  765,  775,  785, 793,  796,  799,  808, 825, 837, 847}};
