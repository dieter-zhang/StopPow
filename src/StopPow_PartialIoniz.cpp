...
StopPow_PartialIoniz::StopPow_PartialIoniz(double mt_in, double Zt_in, std::vector<double> & mf_in, std::vector<double> & Zf_in, std::vector<double> & Tf_in, std::vector<double> & nf_in, std::vector<double> & Zbar_in, double Te_in)
{
...
StopPow_PartialIoniz::StopPow_PartialIoniz(double mt_in, double Zt_in, std::vector< std::array<double,5> > & field, double Te_in)
{
	// default mode is length:
	set_mode(MODE_LENGTH);
