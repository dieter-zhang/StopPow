...
void shift(StopPow & model, double thickness, std::vector<double> & data_E, std::vector<double> & data_Y)
{
...
void shift(StopPow & model, double thickness, std::vector<double> & data_E, std::vector<double> & data_Y, std::vector<double> & data_err)
{
	/*
