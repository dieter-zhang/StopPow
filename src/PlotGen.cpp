...
bool get_dEdx_vs_E(StopPow& model, std::vector<std::vector<double>>& data)
{
    ...
    return get_dEdx_vs_E(model, PLOT_DEFAULT_NUM_POINTS, data);
}
...
bool get_dEdx_vs_E(StopPow& model, int num_points, std::vector<std::vector<double>>& data)
{
    ...
    return get_dEdx_vs_E(model, model.get_Emin(), model.get_Emax(), num_points, data);
}
...
{
    return get_Range_vs_E(model, PLOT_DEFAULT_NUM_POINTS, data);
}

// generate a plot of range vs E for a given model. Results stored in data
bool get_Range_vs_E(StopPow& model, int num_points, std::vector<std::vector<double>>& data)
{
    return get_Range_vs_E(model, model.get_Emin(), model.get_Emax(), num_points, data);
}
...
{
    return get_Eout_vs_Ein(model, PLOT_DEFAULT_NUM_POINTS, Thickness, data);
}
                     ...
                     std::vector<std::vector<double>>& data)
{
    ...
    return get_Eout_vs_Ein(model, Emin, Emax, num_points, Thickness, data);
}
...
{
    return get_Eout_vs_Thickness(model, PLOT_DEFAULT_NUM_POINTS, Ein, data);
}
                           ...
                           std::vector<std::vector<double>>& data)
{
    ...
    return get_Eout_vs_Thickness(model, Tmin, Tmax, num_points, Ein, data);
}
...
{
    return get_Ein_vs_Eout(model, PLOT_DEFAULT_NUM_POINTS, Thickness, data);
}
                     ...
                     std::vector<std::vector<double>>& data)
{
    ...
    return get_Ein_vs_Eout(model, Emin, Emax, num_points, Thickness, data);
}
...
{
    return get_Ein_vs_Thickness(model, PLOT_DEFAULT_NUM_POINTS, Eout, data);
}
                          ...
                          std::vector<std::vector<double>>& data)
{
    ...
    return get_Ein_vs_Thickness(model, Tmin, Tmax, num_points, Eout, data);
}
...
{
    return get_Thickness_vs_Eout(model, PLOT_DEFAULT_NUM_POINTS, Ein, data);
}
                           ...
                           std::vector<std::vector<double>>& data)
{
    ...
    return get_Thickness_vs_Eout(model, model.get_Emin(), Ein, num_points, Ein, data);
}
...
{
    return get_Thickness_vs_Ein(model, PLOT_DEFAULT_NUM_POINTS, Eout, data);
}
                          ...
                          std::vector<std::vector<double>>& data)
{
    ...
    return get_Thickness_vs_Ein(model, Eout, model.get_Emax(), num_points, Eout, data);
}
