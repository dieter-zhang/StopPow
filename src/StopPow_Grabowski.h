...
public:
	 ...
	 */
	StopPow_Grabowski(double mt, double Zt, std::vector<double> & mf , std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf);
	 ...
	 * [mf,Zf,Tf,nf] in units of AMU, e, keV, and 1/cc
 	 * @throws invalid_argument
	 */
	StopPow_Grabowski(double mt, double Zt, std::vector< std::array<double,4> > & field);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	StopPow_Grabowski(double mt, double Zt, std::vector<double> & mf , std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf, double Te);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	StopPow_Grabowski(double mt, double Zt, std::vector< std::array<double,4> > & field, double Te);
