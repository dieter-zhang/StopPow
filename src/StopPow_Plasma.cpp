...
StopPow_Plasma::StopPow_Plasma(double mt_in, double Zt_in, std::vector<double> & mf_in, std::vector<double> & Zf_in, std::vector<double> & Tf_in, std::vector<double> & nf_in)
{
...
StopPow_Plasma::StopPow_Plasma(double mt_in, double Zt_in, std::vector< std::array<double,4> > & field)
{
	// default mode is length:
	set_mode(MODE_LENGTH);
...
StopPow_Plasma::StopPow_Plasma(double mt_in, double Zt_in, std::vector<double> & mf_in, std::vector<double> & Zf_in, std::vector<double> & Tf_in, std::vector<double> & nf_in, double Te_in)
{
	// default mode is length:
	set_mode(MODE_LENGTH);
...
StopPow_Plasma::StopPow_Plasma(double mt_in, double Zt_in, std::vector< std::array<double,4> > & field, double Te_in)
{
	// default mode is length:
	set_mode(MODE_LENGTH);
...
double StopPow_Plasma::dEdx_plasma_electrons(double E)
{
...
double StopPow_Plasma::dEdx_plasma_ions(double E)
{
	double ret = 0;
	// loop over all field particles
	for(int i=0; i < num; i++)
...
void StopPow_Plasma::set_particle(double mt_in, double Zt_in)
{
	// sanity check
...
void StopPow_Plasma::set_field(std::vector<double> & mf_in, std::vector<double> & Zf_in, std::vector<double> & Tf_in, std::vector<double> & nf_in)
{
...
void StopPow_Plasma::set_field(std::vector<double> & mf_in, std::vector<double> & Zf_in, std::vector<double> & Tf_in, std::vector<double> & nf_in, double Te)
{
...
void StopPow_Plasma::set_field(std::vector< std::array<double,4> > & field)
{
...
void StopPow_Plasma::set_field(std::vector< std::array<double,4> > & field, double Te)
{
	// Convert field particle info:
	std::vector<double> mf, Zf, Tf, nf;
	for( std::array<double,4> row : field)
