...
public:
	 ...
	 */
	StopPow_Plasma(double mt, double Zt, std::vector<double> & mf, std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf);
	 ...
	 * [mf,Zf,Tf,nf] in units of AMU, e, keV, and 1/cc
 	 * @throws invalid_argument
	 */
	StopPow_Plasma(double mt, double Zt, std::vector< std::array<double,4> > & field);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	StopPow_Plasma(double mt, double Zt, std::vector<double> & mf, std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf, double Te);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	StopPow_Plasma(double mt, double Zt, std::vector< std::array<double,4> > & field, double Te);
	...
	* @param E the projectile energy in MeV
 	* @throws invalid_argument
	*/
	double dEdx_plasma_electrons(double E);

	/** Get stopping power due only to ions
	* @param E the projectile energy in MeV
 	* @throws invalid_argument
	*/
	double dEdx_plasma_ions(double E);
	 ...
	 * @param nf vector containing ordered field ion densities in units of 1/cm3
 	 * @throws invalid_argument
	 */
	void set_field(std::vector<double> & mf, std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf);
	 ...
	 * [mf,Zf,Tf,nf] in units of AMU, e, keV, and 1/cc
 	 * @throws invalid_argument
	 */
	void set_field(std::vector< std::array<double,4> > & field);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	void set_field(std::vector<double> & mf, std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf, double Te);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	void set_field(std::vector< std::array<double,4> > & field, double Te);
