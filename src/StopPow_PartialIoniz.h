...
public:
	 ...
	 */
	StopPow_PartialIoniz(double mt, double Zt, std::vector<double> & mf, std::vector<double> & Zf, std::vector<double> & Tf, std::vector<double> & nf, std::vector<double> & Zbar, double Te);
	 ...
	 * @param Te the electron temperature in keV
 	 * @throws invalid_argument
	 */
	StopPow_PartialIoniz(double mt, double Zt, std::vector< std::array<double,5> > & field, double Te);
	 ...
	 * [mf,Zf,Tf,nf,Zbar] in units of AMU, e, keV, and 1/cc, e
 	 ...
 	 * @throws invalid_argument
	 */
	void set_field(std::vector< std::array<double,5> > & field, double Te);
